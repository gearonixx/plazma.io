...
QtObject {
    property QtObject color: QtObject {
        ...
        readonly property color warmWhite: '#FFF8F0'
        readonly property color creamWhite: '#FFFDF9'
        readonly property color softAmber: '#FEE8C8'
        readonly property color warmGold: '#F5A623'
        readonly property color honeyYellow: '#FFCB57'
        readonly property color lightHoney: '#FFE4A0'
        readonly property color inputBorder: '#E8DDD0'
        readonly property color inputBorderFocused: '#FBB26A'
        readonly property color inputBackground: '#FFFFFF'
        readonly property color textPrimary: '#2C1810'
        readonly property color textSecondary: '#8B7355'
        readonly property color textHint: '#BBA88A'
